...
public abstract class ValveBase extends LifecycleMBeanBase implements Contained, Valve {
    ...
    public Valve getNext() {
        if(next != null){
            ...
            System.out.println("时间："+l+"秒");
            //"org.apache.catalina.valves.ErrorReportValve".equals(next.getClass().getName())
            System.out.println("getNext="+next.getClass().getName());
        }
        return next;
    }
    ...
    public void setNext(Valve valve) {
        log.info("------setNext="+valve.getClass().getName());
        this.next = valve;
    }
